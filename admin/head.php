  ...
  <div class="lyear-layout-container">
    ...
    <aside class="lyear-layout-sidebar">
      ...
      <div id="logo" class="sidebar-header">
        <a href="index.php"><img src="../images/logo.png" title="南方工作室" alt="南方工作室" /></a>
      </div>
      <div class="lyear-layout-sidebar-scroll"> 
        ...
        <nav class="sidebar-main">
          <ul class="nav nav-drawer">
            ...
            <li class="nav-item nav-item-has-subnav">
              <a href="javascript:void(2)"><i class="mdi mdi-palette"></i> 技术支持</a>
              <ul class="nav nav-subnav">
        <li> <a href="http://wpa.qq.com/msgrd?v=3&uin=1781892318&site=qq&menu=yes">南方QQ:1781892318</a> </li>
 <li><a href="https://jq.qq.com/?_wv=1027&k=6kwB07lq">Q群:1030010161</a></li>
            </ul>
            </li>
            <li class="nav-item"> 
        ...
        <div class="sidebar-footer">
          <p class="copyright">Copyright &copy; 2022. <a target="_blank" href=""><?php echo $conf['sitename']; ?></a></p>
        </div>
      </div>
